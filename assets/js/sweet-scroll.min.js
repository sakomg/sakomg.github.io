...
!function (t, n) {
    ...
    var at = Math.cos, st = Math.sin, ct = Math.pow, ht = Math.abs, ft = Math.sqrt, pt = Math.asin, dt = Math.PI,
        vt = Math.max, gt = Math.min, yt = Math.round,
    ...
    var Ot = !("undefined" == typeof window || !window.document || !window.document.createElement), It = function () {
        ...
        }(), _t = Ot ? window : null, xt = Ot ? document : null, Lt = {y: "scrollTop", x: "scrollLeft"},
        Et = {y: "pageYOffset", x: "pageXOffset"}, At = Object.freeze({
            ...
            InBounce: lt,
            InOutBounce: ut
        }), Mt = ["ms", "moz", "webkit"], Rt = 0, Tt = Ot ? _t.requestAnimationFrame : null,
    ...
    var Dt = function () {
        ...
        return kt(t, [{
            ...
            key: "_loop", value: function (t) {
                ...
                var e = this.el, i = this.props, o = this.options, r = this.startTime, l = this.startProps,
                    u = this.easing, a = o.duration, c = o.step, h = {}, f = t - r, p = gt(1, vt(f / a, 0));
                s(i, function (t, n) {
                    var e = l[n], i = t - e;
                    if (0 === i) return !0;
                    var o = u(p, a * p, 0, 1, a);
        ...
        return kt(t, [{
            ...
            key: "to", value: function (t) {
                ...
                if (!this.isSSR) {
                    var o = this.container, r = c({}, this.options, i), l = this._trigger,
                        u = e(t) && /^#/.test(t) ? t : null;
            ...
            key: "parseCoodinate", value: function (t) {
                ...
                if (a(t, "top") || a(t, "left")) i = c(i, t); else if (o(t)) 2 === t.length ? (i.top = t[0], i.left = t[1]) : (i.top = n ? t[0] : 0, i.left = n ? 0 : t[0]); else if (l(t)) i.top = n ? t : 0, i.left = n ? 0 : t; else {
                    ...
                    if (/^\d+,\d+$/.test(r)) r = r.split(","), i.top = r[0], i.left = r[1]; else if (/^(top|left):\d+,?(?:(top|left):\d+)?$/.test(r)) {
                        ...
                        var f = _(this.container, n ? "y" : "x"), p = r.match(/^(\+|-)=(\d+)$/), d = p[1],
                            v = parseInt(p[2], 10);
            ...
            key: "handleContainerClick", value: function (t) {
                for (var n = this.options, e = t.target; e && e !== xt; e = e.parentNode) if (v(e, n.trigger)) {
                    var i = e.getAttribute("data-scroll"), o = this.parseDataOptions(e),
